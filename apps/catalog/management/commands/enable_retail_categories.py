...
RETAIL_CATEGORIES = {
    ...
    31:  'Тепловентиляторы',
    38:  'Тепловые завесы',
    # 99 «ИК потолочные» слита с 36 командой merge_categories, и целевая
    # переименована в «Инфракрасные обогреватели» — держим актуальное имя,
    # иначе команда честно ругается на расхождение и пропускает категорию.
    36:  'Инфракрасные обогреватели',
...
OWN_CATEGORIES = {
    ...
    # Розница Daichi, которой нет в дереве Бриза (2026-08-30).
    'Бытовые вентиляторы': 'bytovye-ventilyatory',
    'Оконные кондиционеры': 'okonnye-konditsionery',
}
